class VaidyasController < ApplicationController
  ...
  def new
    ...
    contact_doc=@vaidya.contact_docs.new
  ...
  @vaidyas = Vaidya.order("name").page(params[:page]).per(2)
  #@doc = Vaidya.order("name").page(params[:page])
    ...
    @vaidya = Vaidya.new(params[:vaidya])
     ...
     respond_to do |format|
      if @vaidya.save
        ...
        rate = Rate.create(:rateable_id => @vaidya.id,:rateable_type => "Vaidya", :stars => 1)
